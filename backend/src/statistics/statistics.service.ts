...
export class StatisticsService {
    ...
    async getStatistics(customerId: number): Promise<any> {
        try {
            ...
            const totalsResult = await this.expenseRepository.query(totalsQuery, [customerId]);
            ...
            const expensesResult = await this.expenseRepository.query(expensesQuery, [customerId]);
            ...
            const incomeResult = await this.expenseRepository.query(incomeQuery, [customerId]);
